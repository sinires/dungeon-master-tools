...
import { CurrentTurnInfo } from '@entities/tracker/ui/CurrentTurnInfo'
import { RoundInfo } from '@entities/tracker/ui/RoundInfo'
  ...
  return (
    <Card>
      <Flex vertical gap={ESpacer.SPACER3}>
        ...
        <AddCombatantForm />
        <Flex justify="space-between" align="center" gap={ESpacer.SPACER3}>
          <CurrentTurnInfo currentTurn={currentTurn} />
          <RoundInfo battleRound={battleRound} />
        </Flex>
